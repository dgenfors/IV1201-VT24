...
const setApplicationUnhandled = function(username){return 'UPDATE person SET application_status="Unhandled" WHERE person.id = (SELECT person_id FROM person WHERE username = \'' + username + '\');'}
